    ...
    if cmd == "operator":
        ...
        if args.operator_command == "adopt":
            ...
            if args.operator_adopt_command == "import-issues":
                return operator_cmd.adoption_import_issues(
                    target=args.target, dry_run=args.dry_run, json_output=args.json
                )
        ...
        if args.operator_command == "migration":
            ...
            if args.operator_migration_command == "import-issues":
                return operator_cmd.migration_import_issues(
                    target=args.target, dry_run=args.dry_run, json_output=args.json
                )
        ...
        if args.operator_command == "surfaces":
            ...
            if args.operator_surfaces_command == "import-issues":
                return operator_cmd.surfaces_import_issues(
                    target=args.target, dry_run=args.dry_run, json_output=args.json
                )
    ...
    if cmd == "release":
        ...
        if args.release_command == "smoke":
            ...
            if args.release_smoke_command == "show":
                return release_cmd.install_smoke_show(
                    target=args.target, receipt_id=args.receipt_id, json_output=args.json
                )
        ...
        if args.release_command == "candidate":
            ...
            if args.release_candidate_command == "show":
                return release_cmd.candidate_show(
    ...
    if cmd == "repos":
        ...
        if args.repos_command == "actions":
            ...
            if args.repos_actions_command == "context":
                ...
                return repos_cmd.actions_context_build(
                    target=args.target, action_id=args.action_id, json_output=args.json
                )
        ...
        if args.repos_command == "release":
            ...
            if args.repos_release_command == "actions":
                if args.repos_release_actions_command == "plan":
                    return repos_cmd.release_actions_plan(
    ...
    if cmd == "chat":
        ...
        if args.chat_command == "sweep":
            ...
            if args.sweep_command == "import-issues":
                return chat_cmd.sweep_import_issues(
                    target=args.target, surface_id=args.surface_id, json_output=args.json
                )
