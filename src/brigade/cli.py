...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p_init.add_argument(
        "--harnesses",
        default=None,
        help="Comma-separated harness ids: claude, codex, opencode, antigravity, pi, cursor, openclaw, hermes. "
    ...
    p_operator_verify_harness.add_argument("--harness", choices=["claude", "codex", "opencode", "antigravity", "pi", "cursor", "openclaw", "hermes"], required=True, help="Harness id to verify.")
    ...
    p_handoff_draft.add_argument("--inbox", default="codex", help="Writer inbox path or alias: claude, codex, opencode, antigravity, pi, cursor, hermes.")
    ...
    p_research_export.add_argument("--inbox", choices=("codex", "claude", "opencode", "antigravity", "pi", "cursor", "hermes"), default=None, help="Writer harness inbox to export into.")
