...
KNOWN_HARNESSES = ("claude", "codex", "opencode", "antigravity", "pi", "cursor", "hermes", "openclaw", "mcp", "scripts")
...
DEFAULT_TOOLS = (
    {
        ...
        "supported_harnesses": ["claude", "codex", "opencode", "antigravity", "pi", "cursor", "hermes", "openclaw", "mcp", "scripts"],
        "projections": {
