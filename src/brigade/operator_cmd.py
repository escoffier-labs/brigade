...
def doctor_payload(target: Path, *, profile: str = "internal-dogfood") -> dict[str, Any]:
    ...
    return {
        ...
        "tracked_vs_generated": [
            ...
            "Generated harness projections and handoff inboxes under .claude/, .codex/, .opencode/, .antigravity/, .pi/, .cursor/, .hermes/, .openclaw/, .mcp/, and scripts/ are local ignored state.",
...
def verify_harness_payload(target: Path, *, harness: str) -> dict[str, Any]:
    ...
    if inbox_rel is None:
        ...
        return {
            ...
            "issue_count": 1,
            "ready": False,
            "next_command": "choose a writer harness: claude, codex, opencode, antigravity, pi, cursor, hermes",
        }
