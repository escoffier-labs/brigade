...
_OWNERS = {
    ...
    "FleetModelPolicyResolution": "orchestrator",
    "NOOP_DETAIL": "prompts",
    ...
    "_model_lease_lifecycle": "orchestrator",
    ...
    "record_worktree_removal": "artifacts",
    "resolve_fleet_model_policy": "orchestrator",
