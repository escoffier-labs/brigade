...
- [token-glace-output-compaction](memory/cards/token-glace-output-compaction.md) - Claude Code and Codex output compaction setup, wrapper notes, and savings expectations
