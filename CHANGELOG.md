...
- Fleet claim heartbeats now schedule holder-token-fenced orphan cleanup when
  a lost-row re-acquire exceeds its deadline, preventing a late hub commit
  from leaving the workspace claimed after the run exits. Fixes #1142.
### Added
