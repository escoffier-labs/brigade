...
- JSON run contracts rewrite home-directory prefixes (`/home/<user>`, `/Users/<user>`) to `~` on `verification[].commands[].command`, `run.failure.detail`, and watch `final` text. Artifacts and human CLI output are unchanged. Refs #631. Refs #958.
