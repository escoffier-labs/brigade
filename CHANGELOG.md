...
### Changed
- Keep session handoffs, model-rating artifacts, raw model reviews, and announcement drafts out of the public tree. CI rejects tracked files excluded by repository ignore rules.
