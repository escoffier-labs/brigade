...
### Added
- Dogfood runs can now use configured `--agent-cli` adapters for Claude Code, Codex, OpenCode, Antigravity through `agy --print`, or `ollama:<model>` instead of being hardwired to Codex.
