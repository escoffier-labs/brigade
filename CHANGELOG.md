...
- `brigade route <task> [--template --approve-ship --json]` shows the composed route for a task: signals, stages with the signal that pulled each in, parallel waves, and held stages.
