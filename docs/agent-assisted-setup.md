...
- inventory current files such as `AGENTS.md`, `CLAUDE.md`, `MEMORY.md`, `TOOLS.md`, `.codex/`, `.claude/`, `.opencode/`, `.antigravity/`, `.hermes/`, and `.openclaw/`
...
brigade operator quickstart --target . --harnesses codex,claude,opencode,antigravity
brigade operator quickstart --target . --depth workspace --harnesses openclaw,hermes --owner openclaw
```
