...
- `brigade receipts`: 16 command path(s)
...
- `brigade run`: 47 command path(s)
- `brigade run-cloud` (deprecated; use `brigade run cloud`): 45 command path(s)
...
- `brigade receipts export commit-linkage`
...
- `brigade receipts verify-commit-linkage`
...
- `brigade research doctor` (extras)
...
- `brigade research status` (extras)
