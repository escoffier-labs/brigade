...
- `brigade repos adoption repair --state bypassed --dry-run` lists one safe repair or investigation command for each matching row. It never runs those commands or writes target repositories.
