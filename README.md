...
- `brigade repos release waivers record/list/show/revoke` records explicit local waivers for blocked repos, unresolved actions, missing evidence, or blocked evidence. Active waivers are visible in the ready gate and can be revoked when risk changes.
