...
- Build local release candidate packets before manual publish steps. Status: implemented with `brigade release candidate plan/build/list/show/archive`, local candidate bundles, evidence JSON, release notes drafts with secret-looking value redaction, manual-only publish plans, candidate health warnings, and no remote mutation.
